...
const zhCN = {
  ...
  admin: {
    ...
    prevPage: "上一页",
    nextPage: "下一页",
    noteTemplates: ["资料完整，可通过", "信息不足，请补充资料", "风险较高，建议拒绝"],
    overview: "数据看板",
    resourceReview: "资源审核",
    demandReview: "需求审核",
    matchReview: "对接申请",
    ...
    resourceContact: "资源联系方式",
    followUp: "跟进记录",
    followUpNote: "跟进内容",
    followUpNotePlaceholder: "记录本次沟通、风险判断或资料核对结果",
    nextStep: "下一步",
    nextStepPlaceholder: "例如：电话确认渠道能力 / 等待补充资料",
    addFollowUp: "新增跟进",
    followUpSaved: "跟进记录已保存",
    noFollowUps: "暂无跟进记录",
    createdAt: "提交时间",
    reviewedAt: "审核时间",
    contactUnlockedAt: "开放时间",
    intent: "申请说明",
    note: "审核备注",
    recentAudit: "最近审核记录",
    totalUsers: "用户总数",
...
const en = {
  ...
  admin: {
    ...
    pageSummary: "Page {page} / {totalPages}, {total} records",
    prevPage: "Previous",
    nextPage: "Next",
    noteTemplates: ["Complete enough to approve", "More information required", "High risk, reject recommended"],
    overview: "Dashboard",
